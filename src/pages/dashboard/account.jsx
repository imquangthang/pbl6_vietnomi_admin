    ...
    return (
        ...
        <Card>
            ...
            <div>
                ...
                <thead>
                <tr>
                    {["ID", "First Name", "Last Name", "Username", "Email", "Role", "Avatar", "Action"].map((el) => (
                    <th
                        key={el}
                ...
                <tbody>
                {listUsers.map(
                    ({ id, first_name, last_name, username, email, role, avatar_url }, key) => {
                    ...
                    return (
                        ...
                        <td className={className}>
                            <div className="flex items-center gap-4">                            
                            <Avatar src={avatar_url} alt={"avatar"} size="sm" variant="rounded" />
                            </div>
                        </td>  
                        <td className={className}>
                            <div className="flex items-center gap-4">                            
